...
namespace CASMUL.Controllers
{
    public class CablesController : Controller
    {
        public ActionResult Index()
        {
            ...
            {
                var list = contextCm.cable.ToList().Select(x => new ListCableViewModel { IdCable = x.id_cable, Hectarias = x.hectaria, Acres = x.acres, Activo = x.activo, Grupo = x.grupo.descripcion }).ToList();
                return View(list);
            }
